...
constexpr uint32_t LEFT_MASK =      (1UL << M1_FWD) | (1UL << M2_BKWD) | (1UL << M3_BKWD) | (1UL << M4_FWD);

constexpr uint32_t RIGHT_MASK =     (1UL << M1_BKWD) | (1UL << M2_FWD) | (1UL << M3_FWD) | (1UL << M4_BKWD);
...
inline void motorsLEFT(){
    GPIO.out_w1tc = ALL_MOTOR_MASK;
    GPIO.out_w1ts = BKWD_MASK;
}
inline void motorsRIGHT(){
    GPIO.out_w1tc = ALL_MOTOR_MASK;
    GPIO.out_w1ts = BKWD_MASK;
}
